...
window.onload = function () {
  ...
  let sessionInfo = JSON.parse(localStorage.getItem("sessionToken"));
  
  name.innerText = sessionInfo.name;
  email.innerText = sessionInfo.email;
  id.innerText = `Session id = ${sessionInfo.id}`;
